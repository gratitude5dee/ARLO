...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Processing screen capture analysis...');
    console.log('Image data length:', imageBase64.length);
    console.log('User prompt provided:', !!userPrompt);
    ...
    console.log('Screen analysis result:', description.substring(0, 100) + '...');
